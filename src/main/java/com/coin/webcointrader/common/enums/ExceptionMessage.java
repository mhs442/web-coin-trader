...
public enum ExceptionMessage {
    ...
    INVALID_PATTERN_COUNT(HttpStatus.BAD_REQUEST, "각 단계에는 패턴이 정확히 2개 필요합니다 (LONG 시작 1개 + SHORT 시작 1개)."),
    ...
    INVALID_STOP_LOSS_RATE(HttpStatus.BAD_REQUEST, "손절 비율은 0% 초과 100% 미만이어야 합니다."),
